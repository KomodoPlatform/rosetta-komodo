...
var CustomParams = CustomParamStruct{
	Net:              0x8de4eef9, // mainnet HD version bytes (F9 EE E4 8D)
	PubKeyHashAddrID: 60,         // starts with L
	ScriptHashAddrID: 85,         // starts with M
}
...
func TestAddresses(t *testing.T) {
	tests := []struct {
		...
		{
			name:    "mainnet p2pkh",
			addr:    "RXL3YXG2ceaB6C5hfJcN4fvmLH2C34knhA",
			encoded: "RXL3YXG2ceaB6C5hfJcN4fvmLH2C34knhA",
			valid:   true,
			result: komodoutil.TstAddressPubKeyHash(
				[ripemd160.Size]byte{
					0xf1, 0xdc, 0xe4, 0x18, 0x2f, 0xce, 0x87, 0x57, 0x48, 0xc4,
					0x98, 0x6b, 0x24, 0x0f, 0xf7, 0xd7, 0xbc, 0x3f, 0xff, 0xb0},
		...
		// Positive P2PSH test.
		{
			...
			name:    "mainnet p2psh",
			addr:    "bKtMwYNKZ9DNVjSxvXmEBiQ8hLQBoeRCvj",
			encoded: "bKtMwYNKZ9DNVjSxvXmEBiQ8hLQBoeRCvj",
			valid:   true,
			result: komodoutil.TstAddressScriptHash(
				[ripemd160.Size]byte{
					0x4e, 0x81, 0x00, 0xff, 0x98, 0xae, 0x29, 0x6d, 0x1c, 0x9d,
					0x1a, 0x7d, 0xfa, 0x17, 0xc2, 0xac, 0x31, 0x58, 0x8a, 0x01},
