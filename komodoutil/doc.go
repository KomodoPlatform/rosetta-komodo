...
/*
package komodoutil provides komodo-specific convenience functions and types.

Block Overview

A Block defines a komodo block that provides easier and more efficient
...
A Tx defines a komodo transaction that provides more efficient manipulation of
...
The Address interface provides an abstraction for a Komodo address.  While the
most common type is a pay-to-pubkey-hash, horiKMD already supports others and
