...
const (
	...
	// changing our peers).
	rpcUsername = "komodoshi"
	rpcPassword = "komodoshi"
)
...
// https://godoc.org/github.com/DeckerSU/rosetta-komodo/btcutil#NewAmount
func (b *Client) parseAmount(amount float64) (uint64, error) {
	atomicAmount, err := komodoutil.NewAmount(amount)
	if err != nil {
