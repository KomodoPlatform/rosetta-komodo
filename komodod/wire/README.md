...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/DeckerSU/rosetta-komodo/btcd/wire)
=======
...
```bash
$ go get -u github.com/DeckerSU/rosetta-komodo/btcd/wire
```
