...
usage() {
  this=$1
  cat <<EOF
$this: download pre-compiled Docker images for https://github.com/DeckerSU/rosetta-komodo
...
execute() {
  ...
  docker tag "rosetta-komodo:${TAG}" "rosetta-komodo:latest"
  log_info "loaded rosetta-komodo:${TAG} and tagged as rosetta-komodo:latest"
  rm -rf "${tmpdir}"
